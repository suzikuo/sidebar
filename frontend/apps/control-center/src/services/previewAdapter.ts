...
const schema: SettingsSchema = {
  ...
  appearance: {
    ...
    items: {
      ...
      ui_scale: { label: '界面缩放', description: '适配 4K 与高 DPI 显示器，修改后需重启。', control: 'select', default: 'auto', requiresRestart: true, options: [{ value: 'auto', label: '自动（推荐）' }, { value: '100', label: '100%' }, { value: '125', label: '125%' }, { value: '150', label: '150%' }, { value: '175', label: '175%' }, { value: '200', label: '200%' }] },
      accent_color: { label: '强调色', description: '选中状态和主要操作颜色。', control: 'color', default: '#006874' },
