...
} from '../apps/settings/src/services/settingsModel.ts'
...
test('preview settings default to system-managed display scaling', () => {
  assert.equal(createPreviewSettings().appearance.ui_scale, 'auto')
})
