...
from tools.build_support.plugin_packages import (
...
class RepositoryPluginPackageTest(unittest.TestCase):
    ...
    def test_standalone_build_entry_uses_dist_plugins_by_default(self):
        from tools import build_plugins
    ...
    def test_failed_batch_keeps_previous_published_packages(self):
        from tools.build_support import plugin_packages
